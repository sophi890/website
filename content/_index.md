...
## Publications
- **Woodward, S.M.**, Dominici, F. & Zubizarreta, J.R. (2025). [Understanding Spatial Regression Models from a Weighting Perspective in an Observational Study of Superfund Remediation](https://arxiv.org/pdf/2508.19572). Arxiv preprint. (Under review.)
- **Woodward, S.M.**, Tec, M. & Dominici, F. (2024). [An Instrumental Variables Framework to Unite Spatial Confounding Methods](https://arxiv.org/pdf/2411.10381). Arxiv preprint. (Under review.)
...
## Awards 
- 2025 Recipient of the [Tom Ten Have Award](https://sci-info.org/tom-ten-have-award/) at the American Causal Inference Conference for my [poster](/ACIC_poster_2025_final.pdf) on spatial regression and weighting.
